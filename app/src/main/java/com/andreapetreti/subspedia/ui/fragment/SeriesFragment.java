...
/**
 * A simple {@link Fragment} subclass, used for show the tv series.
...
public class SeriesFragment extends Fragment {
    ...
    /**
     * Key for parameter intent for enable favorite fragment.
     */
    private static final String PARAMETER_SHOW_FAVORITE = "com.andreapetreti.subspedia.show_favorite";

    /**
     * Indicate if the fragment show only favorite or all series.
     */
    private boolean mShowFavorite;

    /**
     * Adapter for series listener
     */
    private SerieListAdapter mSerieListAdapter;

    /**
     * Loading bar with message, showed when loading list.
     */
